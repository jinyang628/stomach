...
async def test_post_success():
    ...
    input_data = [InferenceDbInput(entry_id="123", conversation="Test conversation", summary="Test summary", practice="Test practice")]

    with patch('app.services.inference_service.InferenceObjectStore', return_value=mock_inference_store):
        with patch('app.services.inference_service.Inference.local', return_value=mock_inference):
