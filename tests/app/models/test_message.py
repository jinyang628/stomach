...
def test_assistant_message_valid(user_message_fixture):
    assistant_message_1 = AssistantMessage(
        content="Assistant", prev_message=None, next_message=None
    )
    ...
    assistant_message_2 = AssistantMessage(
        content="Assistant", prev_message=user_message_fixture, next_message=None
    )
    ...
    assistant_message_3 = AssistantMessage(
        content="Assistant", prev_message=None, next_message=user_message_fixture
    )
    ...
    assistant_message_4 = AssistantMessage(
        content="Assistant",
        prev_message=user_message_fixture,
        next_message=user_message_fixture,
    )
...
def test_user_message_valid(assistant_message_fixture):
    ...
    user_message_2 = UserMessage(
        content="User", prev_message=assistant_message_fixture, next_message=None
    )
    ...
    user_message_3 = UserMessage(
        content="User", prev_message=None, next_message=assistant_message_fixture
    )
    ...
    user_message_4 = UserMessage(
        content="User",
        prev_message=assistant_message_fixture,
        next_message=assistant_message_fixture,
    )
...
@pytest.mark.parametrize(
    "content, prev_message, next_message, expected_exception", MESSAGE_INVALID_DATA
)
...
SETTER_TEST_DATA = [
    (
        UserMessage,
        "prev_message",
        AssistantMessage("Valid AssistantMessage", None, None),
        None,
    ),
    (
        UserMessage,
    ...
    (
        UserMessage,
        "prev_message",
        UserMessage("Valid AssistantMessage", None, None),
        TypeError,
    ),
    (
        UserMessage,
    ...
    (
        AssistantMessage,
        "prev_message",
        UserMessage("Valid UserMessage", None, None),
        None,
    ),
    (
        AssistantMessage,
    ...
    (
        AssistantMessage,
        "prev_message",
        AssistantMessage("Valid UserMessage", None, None),
        TypeError,
    ),
    (
        AssistantMessage,
...
@pytest.mark.parametrize(
    "message_class, setter_attr, value, expected_exception", SETTER_TEST_DATA
)
