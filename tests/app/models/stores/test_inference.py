...
def test_insert_get_update_delete():
    ...
    object_1 = Inference.local(
        ...
        conversation=json.dumps({"title": "test_title", "UserMessage1": "test_user_message_1", "AssistantMessage1": "test_assistant_message_1"}),
    ...
    assert obj_1.exercise == object_1.exercise 
    ...
    assert obj_2.exercise == object_2.exercise 
